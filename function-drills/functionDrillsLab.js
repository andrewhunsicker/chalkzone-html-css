...
//CODE HERE
const compareNums = (num1, num2) => {if(num1 >= num2){return num1}else{return num2} }
console.log(compareNums(8, 9))
...
console.log(exclaimthree("what to type"))
...
//CODE HERE
const faveColorFinder = (color) => {switch(color){
  case "red":
...
//CODE HERE
const printAllNames = (arrayofnames) => {for(let i = 0; i < arrayofnames.length; i++){
...
//CODE HERE
const thatsOdd = (num) =>{if(num % 2 === 0){
  return`that's not odd!!`
  }else{return `That is odd indeed!`}
}
const oddChecker = (thatsOdd(8))
const oddChecker2 = (thatsOdd(9))
...
//CODE HERE
const bigOrSmall = arrayofnumbers => {
  let answers = []
...
*/
const emailCheck = (email) => {email = String(email)
email = email.trim()
if(email.includes(`@`)){
return(`email verified`)}
else{return(`must provide email address`)}
} 
console.log(emailCheck(`randomemail@aol.com`))
...
const totalFrogs = maxchocfrogs(45)
...
//CODE HERE
const numbersort = (arrsample) => {for(let i = 0; i < arrsample.length; i++)
 ...
 return true;}
   ...
   const arrayIsAscending = numbersort(sampleArray)
   console.log(arrayIsAscending)
   // const arrayIsAscending = numbersort()
    //console.log(arrayIsAscending) 
